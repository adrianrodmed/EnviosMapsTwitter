		...
		<table>
			...
			<tr>
				...
				<td><input type="text" name="origen"
					value='<c:out value="${articulo.origen}"></c:out>'></td>
			</tr>
			<tr>
				<td><label>Destino</label></td>
				<td><input type="text" name="nombre"
					value='<c:out value="${articulo.destino}"></c:out>'></td>
			</tr>
			<tr>
				<td><label>Paquete</label></td>
				<td><input type="text" name="paquete"
					value='<c:out value="${articulo.paquete}"></c:out>'></td>
			</tr>
			<tr>
				<td><label>Fecha</label></td>
				<td><input type="text" name="fecha"
					value='<c:out value="${articulo.fecha}"></c:out>'></td>
			</tr>
			<tr>
				<td><label>Remitente</label></td>
				<td><input type="text" name="remitente"
					value='<c:out value="${articulo.remitente}"></c:out>'></td>
			</tr>
			<tr>
				<td><label>Transportista</label></td>
				<td><input type="text" name="transportista"
					value='<c:out value="${articulo.transportista}"></c:out>'></td>
			</tr>
			<tr>
