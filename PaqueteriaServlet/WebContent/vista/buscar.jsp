...
<h2>Introduce los datos</h2>
	...
	<form action="adminArticulo?action=mostrar2">
	 ...
	 <a href="adminArticulo?action=mostrar">Ver todos</a>
 ...
 function initMap() {
     var map = new google.maps.Map(document.getElementById('map'), {
       ...
       center: {lat: 40.428462, lng: -3.704267},
       zoom: 13
     });
...
<!-- AIzaSyCL5rDAiKvf1GR2NknEyMWS_2KgRtjw5Qg -->